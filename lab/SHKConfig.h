...
#define SHKMyAppName			@"Studifutter"
#define SHKMyAppURL				@"http://studifutter.rtfnt.com"
...
#define SHKFacebookKey				@"299378640106226"
#define SHKFacebookSecret			@"ed65e818fdb33c5db6ccb1bef4167aff"
 ...
 */
#define SHKTwitterConsumerKey		@"gmoJNi8UZtAyEbcmc423g"
#define SHKTwitterSecret			@"OmgRVqCjHD9pNOP5kPpA4OBET9pcV1M9kzF65cUPPmo"
#define SHKTwitterCallbackUrl		@"http://studifutter.rtfnt.com" // You need to set this if using OAuth, see note above (xAuth users can skip it)
#define SHKTwitterUseXAuth			0 // To use xAuth, set to 1
#define SHKTwitterUsername			@"studifutter" // Enter your app's twitter account if you'd like to ask the user to follow it when logging in. (Only for xAuth)
