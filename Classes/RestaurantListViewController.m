...
- (id)initWithCurrentRestaurants:(NSMutableArray *)currentRestaurants {
	// load all the restaurants from the web database here
	// remove the currentRestaurants from the web's array here
...
- (void)viewDidLoad {
	...
	restaurantArray = [self createRestaurantArray];
	self.navigationItem.title = @"Favoriten";
}
...
- (NSArray *)createRestaurantArray {
	...
	Restaurant *m1 = [[Restaurant alloc] init];
	...
	Restaurant *m2 = [[Restaurant alloc] init];
	...
	Restaurant *m3 = [[Restaurant alloc] init];
	...
	Restaurant *m4 = [[Restaurant alloc] init];
	...
	Restaurant *m5 = [[Restaurant alloc] init];
	m5.name = @"Mensateria";
	...
	Restaurant *m6 = [[Restaurant alloc] init];
	m6.name = @"Eichstätt";
	...
	Restaurant *m7 = [[Restaurant alloc] init];
	m7.name = @"Ingolstadt";
	...
	Restaurant *m8 = [[Restaurant alloc] init];
	m8.name = @"Ansbach";
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    // Set up the cell...
	Restaurant *m = [restaurantArray objectAtIndex:indexPath.row];
	cell.text = m.name;
